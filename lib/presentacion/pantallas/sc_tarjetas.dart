...
class PantallaTarjetas extends StatelessWidget{
  static const String nombre='tarjetas_pantalla';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tarjetas Pantalla'),
      ),
      body: const _TarjetasMostrar(),
    );
  }
}

class _TarjetasMostrar extends StatelessWidget{
  const _TarjetasMostrar();
  @override
  Widget build(BuildContext context) {
